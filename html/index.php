...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <body>
    ...
    <script>
      ...
      // let domain = prompt("Please enter your domain", "");
      // let email = prompt("Please enter your email to verify your email ", "");
    ...
    <div class="modal-content" style="padding: 10px;">
      <!--<label for="uname"><b>Please enter your domain</b></label>
      <input type="text" placeholder="example: https://google.com" id="input_domain" name="uname" style="width:100%" required>-->

      <label for="psw"><b>Verify your email</b></label>
      <input type="text" placeholder="Confirm your email" id="input_email" name="psw" style="width:100%" required>
      
      <button style="float:right; width:75px; height:40px;" onClick="myfunc()">Ok</button>
    </div>
    ...
    <script>
      function myfunc(){
        ...
        // const domain = document.getElementById("input_domain").value;
          ...
          const key = CryptoJS.MD5(email).toString();
